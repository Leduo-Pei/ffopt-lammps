...
python -m pip install \
  "ffopt-lammps[full] @ https://github.com/Leduo-Pei/ffopt-lammps/releases/download/v0.3.0a7/ffopt_lammps-0.3.0a7-py3-none-any.whl"
```
...
conda deactivate
conda activate ffopt
python -m pip install "ffopt-lammps[full] @ https://github.com/Leduo-Pei/ffopt-lammps/releases/download/v0.3.0a7/ffopt_lammps-0.3.0a7-py3-none-any.whl"
```
